package com.example.recorderaudio.ui.view
...
class CircularProgressView : View {
    ...
    private val paintProgressSec = TextPaint(Paint.ANTI_ALIAS_FLAG)
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        if (attrs != null) {
            ...
            progressWidth =
                typedArray.getDimensionPixelSize(R.styleable.CircularProgressView_progressWidth, 16).toFloat()
            ...
            progressTextType =
                typedArray.getInt(R.styleable.CircularProgressView_progressTextType, PROGRESS_TEXT_TYPE_PROGRESS)
            progressTextSize =
                typedArray.getDimensionPixelSize(R.styleable.CircularProgressView_progressTextSize, 0).toFloat()
            ...
            val interpolatorResId = typedArray.getResourceId(
                R.styleable.CircularProgressView_progressInterpolator,
    ...
    private fun setupPaint() {
        val currentTypeFace = paintProgressSec.typeface
        ...
        paintProgressSec.textSize = progressTextSize / 3
        paintProgressSec.color = progressTextColor
        paintProgressSec.textAlign = Paint.Align.CENTER
        paintProgressSec.typeface = bold
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (progressTextEnabled) {
            ...
            val yyPosition = centerY - ((paintProgressText.descent() + paintProgressText.ascent()) / 2) / 2

            canvas.drawText(
                progressText,
                centerX + ((paintProgressSec.descent() + paintProgressText.ascent()) / 2),
                yPosition,
                paintProgressText
            )
            ...
            canvas.drawText(
                "SEC",
                centerX - ((paintProgressText.descent() + paintProgressText.ascent())),
                yyPosition,
                paintProgressSec
            )
        }
